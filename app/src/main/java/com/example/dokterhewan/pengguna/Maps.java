...
public class Maps extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Maps Dokter Hewan");
    ...
    public void onBackPressed(){
        Intent i = new Intent(Maps.this, SubMenu.class);
        startActivity(i);
        finish();
    }
...
// Create and customize the LocationComponent's options
            LocationComponentOptions customLocationComponentOptions = LocationComponentOptions.builder(this)
                    ...
                    .foregroundDrawable(R.drawable.ic_navigate)
                    .build();
...
// Empty on purpose
    ...
    public void getData(JSONObject jsonObject){
        ...
        final String URL = BaseURL.getDataDokwan + radius;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Icon icon = iconFactory.fromResource(R.drawable.marker_map_dokwan);
                            ...
                            for (int i =0; i < jsonArray.length(); i++){
                                ...
                                markerOptions.setTitle(namaTempat + " - " + jarak);
                                markerOptions.setSnippet(alamat);
