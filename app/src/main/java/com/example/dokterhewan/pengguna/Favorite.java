...
public class Favorite extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterFav(Favorite.this, newsList);
    ...
    public void getAllPet(JSONObject jsonObject) {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, BaseURL.getDataDokwanFav + "0/", jsonObject,
...
//
                                            ...
                                            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                                                ...
                                                Toast.makeText(Favorite.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
