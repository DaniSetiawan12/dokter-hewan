...
public class AdapterDokwanPengguna extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelDokwan> item;

    public AdapterDokwanPengguna(Activity activity, List<ModelDokwan> item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.content_dokwan_users, null);
