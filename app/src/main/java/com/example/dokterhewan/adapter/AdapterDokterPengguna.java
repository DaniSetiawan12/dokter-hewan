...
public class AdapterDokterPengguna extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelDokter> item;

    public AdapterDokterPengguna(Activity activity, List<ModelDokter> item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout linear      = (LinearLayout) convertView.findViewById(R.id.linearEditHapus);
