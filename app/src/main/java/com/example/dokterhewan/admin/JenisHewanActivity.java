...
public class JenisHewanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jenis_hewan2);
        ...
        newsList.clear();
        adapter = new AdapterJenisHewan(JenisHewanActivity.this, newsList);
        ...
        tambahData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pop.on(JenisHewanActivity.this)
                        .with()
                        ...
                        .show(new Pop.View() { // assign value to view element
                            ...
                            public void prepare(View view) {
                                ...
                                txtJudul.setText("Tambah Jenis Hewan");
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                Pop.on(JenisHewanActivity.this)
                        ...
                        .show(new Pop.View() { // assign value to view element
                            ...
                            public void prepare(View view) {
                                TextView txtJudul = (TextView) view.findViewById(R.id.txtJudul);
                                txtJudul.setText("Edit / Hapus Jenis Hewan");
                                final EditText edtNnama = (EditText) view.findViewById(R.id.edtNama);
                                Button btnEdit    = (Button) view.findViewById(R.id.btnEdit);
                                Button btnHapus    = (Button) view.findViewById(R.id.btnHapus);
    ...
    public void ubahJasa(JSONObject datas, String id){
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.PUT, BaseURL.ubahJenisHewan+ _id +"/" +id, datas,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if(status == false){
                                ...
                                Intent i = new Intent(JenisHewanActivity.this, DataDokwanAdmin.class);
    ...
    public void hapusJasa(String id){
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.DELETE, BaseURL.hapusJenisHewan+ _id +"/" +id, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
    ...
    public void onBackPressed(){
        Intent a = new Intent(JenisHewanActivity.this, DetailDokwan.class);
