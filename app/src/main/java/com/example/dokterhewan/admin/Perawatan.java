...
public class Perawatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPerawatan = (EditText) findViewById(R.id.edtPerawatan);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String jenisHewan = edtPerawatan.getText().toString();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status == false){
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(Perawatan.this);
                                builder1.setMessage("Ingin menambah Perawatan ? ");
                                builder1.setCancelable(true);
                                builder1.setPositiveButton(
                                        "Ya",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                edtPerawatan.setText(null);
                                                dialog.cancel();
                                            }
                                        });
                                ...
                                builder1.setNegativeButton(
                                        ...
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                Intent i = new Intent(Perawatan.this, InputDokter.class);
